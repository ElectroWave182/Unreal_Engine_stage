...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Merge multiple glTF Runtime LODs with Transforms"), Category = "glTFRuntime")
	static FglTFRuntimeMeshLOD glTFMergeRuntimeLODsWithTransforms(const TArray<FglTFRuntimeMeshLOD>& RuntimeLODs, const TArray<FTransform>& Transforms);
