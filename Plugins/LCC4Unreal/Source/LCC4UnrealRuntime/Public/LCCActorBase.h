...
#include "LCCActorBase.generated.h"
...
class LCC4UNREALRUNTIME_API ALCCActorBase : public AActor
{
    ...
    TObjectPtr<class ULCCComponentBase> LCCComponent;

    /** Returns LCCComponent **/
    UFUNCTION(BlueprintCallable, Category = "XGrids")
    ULCCComponentBase* GetLCCComponent() const { return LCCComponent; }
